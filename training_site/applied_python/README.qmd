...
We'd like to ask you to familiarize yourself with our [Contribution Guide](CONTRIBUTING.qmd)
...
A list of contributors to the lesson can be found in [AUTHORS.qmd](AUTHORS.qmd).
...
under the [MIT license][mit-license]. For more information, see [LICENSE.qmd](LICENSE.qmd).
