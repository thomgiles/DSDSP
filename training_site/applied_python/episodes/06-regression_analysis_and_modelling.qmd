...
1. Run a linear regression example with `statsmodels` (~20 min) 
2. Run a complete linear regression workflow in `scikit-learn` (~20 min)
...
We will use `scikit-learn` to build the full linear regression example in stages.
