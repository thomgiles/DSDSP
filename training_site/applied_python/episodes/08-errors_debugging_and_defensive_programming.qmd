...
## Challenge: So what error did the program actually
...
## If you encounter an error and don't know
...
## Practice Prompt: Long Tracebacks
...
## Code Example: Reading Error Messages
...
## Practice Prompt: Reading Error Messages

::: callout-note

## Worked Solution: Reading Error Messages
...
## Worked Solution Prompt: Reading Error Messages
...
## Challenge: People can typically figure out what
...
## Both SyntaxError and IndentationError indicate a problem
...
## Variable name errors come with some
...
## Code Example: Variable Name Errors

```{python}
print(hello)
```

## The second reason is that you might
...
## Finally the third possibility is that you made
...
## Code Example: File Errors

```{python}
file_handle = open('myfile.txt', 'r')
```

## One reason for receiving this error
...
## A related issue can occur if you use
...
## Code Example: Identifying Syntax Errors
...
## Worked Solution: Identifying Syntax Errors
...
## Worked Solution Code: Identifying Syntax Errors
...
## Worked Solution Prompt: Identifying Syntax Errors
...
## Code Example: Identifying Variable Name Errors
...
## Practice Prompt: Identifying Variable Name Errors

::: callout-note

## Worked Solution: Identifying Variable Name Errors

3 `NameError`s for `number` being misspelled, for `message` not defined, and for `a` not being in quotes.

Fixed version:

## Worked Solution Code: Identifying Variable Name Errors
...
## Worked Solution Prompt: Identifying Variable Name Errors
...
## Practice Prompt: Identifying Index Errors

::: callout-note

## Worked Solution: Identifying Index Errors
...
## Programs like the Firefox browser are full
...
## The preconditions on lines 6 8 and 9
...
## The post-conditions on lines 20 and 21 help
...
## But if we normalize one that's wider than
...
## Most good programmers follow two rules when adding
...
## The second rule is turn bugs into assertions
...
## Novices often solve this problem like
...
## Challenge: If people write tests after writing
...
## Challenge: And what about this case
...
## Challenge: Do two segments that touch
...
## Since we're planning to use the range
...
## Now test range_overlap with a single function call
...
## Practice Prompt: Test-Driven Development
...
> 🔀 Conditionals make program behavior depend on data state.

## Worked Solution Code: Pre- and Post-Conditions
...
## Worked Solution Prompt: Pre- and Post-Conditions
...
## Explain in words what the assertions
...
## Practice Prompt: Testing Assertions

::: callout-note

## Worked Solution: Testing Assertions
...
## But writing test cases for scientific software
...
## Challenge: Compare to an oracle
...
## Challenge: Check conservation laws
...
## As well as making the program fail fast
...
## Challenge: The smaller the gap between cause
...
## Challenge: N things can interact in N different
...
## Records are particularly useful when the time comes
...
## Part of being humble is learning

Part of being humble is learning from our mistakes. Programmers tend to get the same things wrong over and over: either they don't understand the language and libraries they're working with, or their model of how things work is wrong. In either case, taking note of why the error occurred and checking for it next time quickly turns into not making the mistake at all.

## Challenge: And that is what makes us most
...
> 🐞 Change one thing at a time so you can isolate the cause.
...
## Code Example: Not Supposed to be the Same
...
## Worked Solution Prompt: Not Supposed to be the Same
