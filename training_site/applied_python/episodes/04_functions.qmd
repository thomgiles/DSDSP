...
but we don't need to. Instead, we can [compose](../learners/reference.qmd#compose) the two functions we have already created:
...
then combine them in ever-larger chunks to get the effect we want. Real-life functions will usually be larger than the ones shown here --- typically half a dozen
...
> 🛡️ Tests catch mistakes early and make code safer.
...
## Solution: Selecting characters from strings
...
## Solution: Testing and documenting your function
...
### Solution: Variables inside and outside functions
...
### Solution: Mixing default and non-default parameters
