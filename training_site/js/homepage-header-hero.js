class HomepageHeaderHero extends HTMLElement {
  constructor() {
    super();
...
if (!customElements.get("homepage-header-hero")) {
  customElements.define("homepage-header-hero", HomepageHeaderHero);
}

function mountHomepageHeaderHero() {
  if (document.querySelector("homepage-header-hero")) return;

  const main = document.querySelector("main#quarto-document-content") || document.body;
  const hero = document.createElement("homepage-header-hero");
  main.insertBefore(hero, main.firstChild);
}

if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", mountHomepageHeaderHero);
} else {
  mountHomepageHeaderHero();
}
