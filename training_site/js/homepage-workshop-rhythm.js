class HomepageWorkshopRhythm extends HTMLElement {
  constructor() {
    super();
...
if (!customElements.get("homepage-workshop-rhythm")) {
  customElements.define("homepage-workshop-rhythm", HomepageWorkshopRhythm);
}
