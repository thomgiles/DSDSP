...
5. **Public Task** Necessary for performing a task in the public interest or in the exercise of official authority. *Most UK universities rely on this for research.*
6. **Legitimate Interests** Permitted where processing is necessary and impact on individuals is minimal and where interests are balanced. *Used selectively when Public Task does not apply.*
