...
1. **Consent** Freely given, specific, informed, and unambiguous. *Used in research only when genuinely optional and without imbalance of power.*
...
5. **Public Task** **(commonly used for research)** Necessary for performing a task in the public interest or in the exercise of official authority. *Most UK universities rely on this basis for research, reflecting their statutory functions.*
6. **Legitimate Interests** **(sometimes used for research)** Permitted where processing is necessary and impact on individuals is minimal, and where interests are balanced. *Used selectively when Public Task does not apply.*
