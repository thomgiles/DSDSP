...
#### Task 1: Principles of Digital Delivery (10m)

* In small groups, discuss examples of how digital tools (e.g. Git, Quarto, Teams) improve visibility, reproducibility, or coordination in your work.
...
* Choose a current project and map its main components (e.g. data, code, documentation).
* Identify where **coordination gaps** or inefficiencies occur.
* Propose how a digital delivery practice—such as version control, automation, or shared dashboards—could close one gap.
* Discuss what new behaviours or tools this would require.

<iframe style="width:100%;max-width:300px;height:300px;" src="https://stopwatch-app.com/widget/timer?theme=light&color=indigo&hrs=0&min=10&sec=0" frameborder="0"></iframe>

**Follow-up:**
How could improved coordination change accountability or decision-making within your project?
:::
...
* Select a small-scale research activity (data validation, exploratory analysis, literature synthesis).
...
**Follow-up:**
Compare your sprint to a conventional workflow. What risks or opportunities does iteration introduce?
:::
...
* Using your sprint from Task 3, assign roles (**Lead**, **Facilitator**, **Team**).
* Walk through a condensed cycle: *Planning → Execution → Review → Retrospective.*
* Discuss how blockers, communication, or feedback would be handled.
* Note one improvement to strengthen collaboration or shared learning.

<iframe style="width:100%;max-width:300px;height:300px;" src="https://stopwatch-app.com/widget/timer?theme=light&color=indigo&hrs=0&min=10&sec=0" frameborder="0"></iframe>

**Follow-up:**
How did the sprint structure influence ownership and adaptability within your team?
:::
