...
![Iterative research delivery loop moving through design, development, testing, documentation, and reflection.](fig/eds-iterative-delivery-loop.svg){fig-align="center" width="78%"}

> 🔁 The loop gives teams permission to adjust the plan when evidence, blockers, or stakeholder needs change.
...
![Digital delivery cycle showing plan, build, share, and learn.](fig/eds-digital-delivery-cycle.svg){fig-align="center" width="62%"}

> 🧭 Small delivery loops keep work visible without turning research into a rigid production line.
...
![Delivery roles loop showing coordination between PI, project coordinator, data scientist, analyst, and developer.](fig/eds-delivery-roles-loop.svg){fig-align="center" width="76%"}

> 🧭 Roles overlap in practice; the point is to keep handovers visible.
...
![Research sprint cycle showing planning, execution, review, and retrospective.](fig/eds-research-sprint-cycle.svg){fig-align="center" width="65%"}

> 🕒 The sprint boundary keeps work small enough to review and improve.
...
![Research culture loop showing shared accountability, psychological safety, continuous learning, and transparency.](fig/eds-research-culture-loop.svg){fig-align="center" width="72%"}

> 💬 A healthy delivery culture makes issues discussable before they become project risks.
