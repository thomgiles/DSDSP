...
![Research data management role map linking project roles to RDM responsibilities.](fig/eds-rdm-roles-map.svg){fig-align="center" width="88%"}

> 🧩 RDM works best when responsibilities are explicit rather than assumed.
...
![Data lifecycle flow from planning and collection through processing, storage, sharing, preservation, and reuse.](fig/eds-data-lifecycle-flow.svg){fig-align="center" width="76%"}

> 🔁 Decisions made early affect whether data can be understood and reused later.
...
![FAIR data cycle showing findable, accessible, interoperable, and reusable principles.](fig/eds-fair-cycle.svg){fig-align="center" width="64%"}

> ♻️ FAIR is a reuse test: can someone find, understand, access, and responsibly use the dataset?
