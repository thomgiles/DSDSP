...
<!-- Hidden by default -->
![](fig/HOAI_qr.png){fig-align="center" width=400px}
...
- **Duration:** ~20 minutes directed teaching (+50 minutes practical exercises)  
...
2. **Group Research with Copilot** – 5 minute small‑group task and 5 minute plenary.  
3. **Critique and Validation** – 5 minute group critique and 5 minute plenary.  
4. **Prompt Framing and Role Effects** – 5 minute role‑prompting experiment and 5 minute plenary.  
5. **Using Agents for Repeated Tasks** – 5 minute role‑prompting experiment and 5 minute plenary.  
6. **Going Further with AI** - 5 minute role‑prompting experiment and 5 minute plenary.  
...
Participants should form upto **around five groups**
...
## LLMs can write their own AI Agents

Create a new agent, but this time use copilot to create the agent prompt instead of writing it yourself. be detailed and specific.

---

::: callout-task

#### Task 5: Build an agent with a LLM

::: panel-tabset
##### Exercise (5 min)
Create another agent, this time using AI to write the prompt. 

The AI agent sould be configured to:
...
- Which was better? the one you wrote or the one self written by AI? 
:::
:::
