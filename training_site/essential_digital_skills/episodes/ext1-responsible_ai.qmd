...
<!-- Hidden by default -->
![](fig/RUAI_qr.png){fig-align="center" width=400px}
...
Responsible use of artificial intelligence in research requires **rebalancing speed with rigour**.

**Artificial intelligence enables speed**

- Faster text and code generation  
- Rapid exploration of alternatives  
- Easier drafting and prototyping  

**Responsibility requires control**

- Stronger verification of outputs  
- Clear decision criteria  
- Explicit claim–evidence mapping  

> 🌐 As automation increases, the burden of evidence and verification increases with it.
...
> You make a claim? Was AI involved? If Yes, Disclose it! 
