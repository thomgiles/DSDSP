...
Downloaded dataset [data/student_data.xlsx](/data/student_data.xlsx)
...
Download the cleaned dataset [data/cleaned_student_data.xlsx](/data/cleaned_student_data.xlsx)
...
Using the cleaned dataset [data/cleaned_student_data.xlsx](/data/cleaned_student_data.xlsx)
...
| Element               | Group Presentation Task                                   |
|-----------------------|-----------------------------------------------------------|
| Hypothesis            | Correlation of Sleep and Activity with Estimated Energy   |
| Variables & Criteria  | Low Energy if Hours Slept > 10.0                          |
| Prediction            | 50%                                                       |
:::
:::
