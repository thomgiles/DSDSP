...
[notional machine](../learners/reference.qmd#notional-machine)
...
1. [Analyzing Patient Data](../episodes/02-R_variables_intro.qmd)
2. [Creating Functions](../episodes/03-R_functions.qmd)
3. [Analyzing Multiple Data Sets](../episodes/04-for_loops.qmd)

An additional half-day could add the next two lessons:

4. Making choices (topic not currently included as a standalone module)
5. Command-Line Programs (topic not currently included as a standalone module)
...
6. Best practices for using R and designing programs (optional extension topic)
7. Dynamic reports with knitr (optional extension topic)
8. Making packages in R (optional extension topic)
...
## [Analyzing Patient Data](../episodes/02-R_variables_intro.qmd)
...
## Addressing Data (supplement topic)

- Note that the data frame `dat` is not the same set of data as in other lessons.

## [Analyzing Multiple Data Sets](../episodes/04-for_loops.qmd)
