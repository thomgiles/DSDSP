...
course-area: "Foundation"
course-level: "Foundation"
course-status: "Core"
course-badge: "Foundation"
course-icon: "🧭"
course-summary: "Core tools, collaboration, delivery, governance, and research data management."
course-tags: ["Digital tools", "Collaboration", "Data governance", "Research data management", "FAIR data", "Information security"]
---
...
- **Main themes:** Collaboration, delivery, governance, research data management, and defensible digital research practice
...
It is also a strong entry point for researchers who plan to continue into [Methods for Data Science](../methods_for_data_science/index.qmd).
...
::: {.item}
### Planning Defensible Workflows

Connect tools, roles, systems, policies, and data decisions into workflows that are easier to explain and maintain.
:::
:::
...
For data quality, exploration, visualisation, and impact, continue to [Methods for Data Science](../methods_for_data_science/index.qmd).

For dedicated AI teaching, see [Responsible Use of Generative AI](../responsible_use_of_generative_ai/index.qmd). That 2-hour course focuses on how AI changes research work and how to use AI more selectively through stronger prompting, validation, documentation, and workflow design.
