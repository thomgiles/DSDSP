...
![Digital data trace sequence showing user interaction, system trace generation, storage, and third-party access.](fig/eds-digital-data-trace.svg){fig-align="center" width="82%"}

> 🚀 Trace data may feel passive, but it is still created, stored, shared, and interpreted through systems.
...
![Good data planning map showing relevance, accuracy, completeness, and consistency with supporting checks.](fig/eds-good-data-mindmap.svg){fig-align="center" width="86%"}

> 🧭 Good datasets are designed around the research question before collection starts.

## How Good Questions Lead to Good Data

![Timeline showing a vague research idea becoming measurable questions, variables, and dropped irrelevant fields.](fig/eds-good-questions-timeline.svg){fig-align="center" width="84%"}

> 📌 Each step removes ambiguity until the data collection plan matches the analysis purpose.
