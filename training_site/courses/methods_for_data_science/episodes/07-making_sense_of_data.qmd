...
**Please Complete following short poll**
...
N.b. this is only active during lessions. 
...
![Effective visual design map connecting simplicity, consistent colours, labelling, and scale choices.](fig/eds-visual-design-principles.svg){fig-align="center" width="78%"}

> 🧠 Good visuals reduce interpretation effort without hiding uncertainty or context.
...
A case study in data interpretation for an App Platform Owner. if you are given a fact like: **60% of users quit!** Without context, this sounds alarming.
