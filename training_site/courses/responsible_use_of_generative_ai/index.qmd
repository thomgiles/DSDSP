...
course-icon: "🤖"
course-summary: "Prompting, checking, critique, and responsible AI decisions."
course-tags: ["Responsible AI", "Prompting", "Validation", "Source checking", "AI governance", "Research workflows"]
---
...
- **Duration:** 2 hours
- **Best for:** Academics, Teaching Staff, Researchers, research staff, doctoral researchers, and professional services colleagues who need clearer judgement about AI use
...
|---|---|---|
| [How AI Impacts Teaching and Research](episodes/ext1-how_ai_impacts_teaching_and_research.qmd) | Opportunities, risks, governance, data security, and how AI changes research work | Builds judgement before tool use becomes routine |
| [How to Use AI in Teaching and Research](episodes/ext2-how_to_use_ai_in_teaching_and_research.qmd) | Prompt design, validation, source-grounded workflows, and practical AI exercises | Turns broad principles into concrete, defensible practice |
...
1. **Hour 1:** [How AI Impacts Research](episodes/ext1-how_ai_impacts_teaching_and_research.qmd)
2. **Hour 2:** [How to Use AI in Research](episodes/ext2-how_to_use_ai_in_teaching_and_research.qmd)
