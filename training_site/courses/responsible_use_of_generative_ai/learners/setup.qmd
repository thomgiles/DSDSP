...
|---|---|
| [Introduction to AI for Research](../episodes/01-Introduction_to_AI_for_research.qmd) | Think of one research task where AI already feels useful and one where it feels risky |
| [Prompting for Research](../episodes/02-Prompting_for_research.qmd) | Bring a low-risk prompt, policy page, reading task, or workflow you want to improve |
| [Applied AI for Research](../episodes/03-Applied_AI_for_research.qmd) | Think of one research workflow you would like to improve; all literature, interview, data and grant examples needed for the discussion are provided |

The applied workshop includes a brief choice of qualitative or quantitative material. You can discuss either route without coding or paid tool access. If you later want to practise with real papers or run generated analysis code, use permitted documents and an approved environment.
