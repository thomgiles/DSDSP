...
| [Applied AI for Research](../episodes/03-Applied_AI_for_research.qmd) | Choose a research question and, optionally, two or three papers you are permitted to upload; synthetic literature, interview, data and grant examples are provided |

For the applied workshop, decide whether you prefer the qualitative or quantitative analysis route. You can complete either route without coding or paid tool access. If you want to run generated analysis code, bring an approved R or Python environment you already use.
