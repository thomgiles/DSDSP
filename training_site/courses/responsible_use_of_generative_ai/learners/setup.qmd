...
|---|---|
| [How AI Impacts Research](../episodes/ext1-how_ai_impacts_teaching_and_research.qmd) | Think of one research task where AI already feels useful and one where it feels risky |
| [How to Use AI in Research](../episodes/ext2-how_to_use_ai_in_teaching_and_research.qmd) | Bring a low-risk prompt, policy page, reading task, or workflow you want to improve |
