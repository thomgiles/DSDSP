...
- Design effective prompts for producing university teaching materials that are aligned with a defined learning outcome, learner level and teaching context.  
- Critically assess AI-generated teaching materials for factual accuracy, pedagogical alignment, accessibility, inclusivity and appropriate academic level.  
- Explore how role, audience and format instructions influence Copilot responses, while recognising that fluent output is not evidence of educational quality.  
...
2. **Generating Teaching Materials with Copilot** – create a source-grounded teaching resource for a defined context.  
3. **Critique and Validation** – evaluate factual accuracy, pedagogical quality, accessibility and alignment.  
4. **Prompt Framing and Role Effects** – compare how different professional perspectives change the output.  
5. **Using Agents for Repeated Tasks** – turn a recurring teaching-material workflow into a structured agent.  
6. **Going Further with AI** – identify responsible uses across teaching and research practice.  

> 🔧 The emphasis is on practical exercises. Short teaching segments provide prompt structure, validation habits and workflow ideas to support each activity.
...
A useful prompt for developing teaching materials normally includes:

- the **task**: what you want Copilot to produce  
- the **learning outcome**: what learners should be able to do  
- the **audience**: level, discipline, prior knowledge and relevant needs  
- the **teaching context**: lecture, seminar, laboratory, workshop or independent study  
- the **source boundary**: the notes, readings or approved evidence it may use  
- the **constraints**: duration, length, tone, accessibility and exclusions  
- the **output format**: slides, explanation, activity, case study, questions or checklist  
- the **quality checks**: what it should flag rather than invent  

> ❓ Useful additional instructions include: **cite the supplied source, distinguish fact from suggestion, and flag uncertainty rather than guessing**.

## A structured teaching prompt
...
# Generating Teaching Materials with Copilot
...
## Possible teaching materials

Copilot can help draft:

- explanations at different levels of complexity  
- worked examples and annotated exemplars  
- seminar or workshop activities  
- case studies and discussion prompts  
- formative questions with model reasoning  
- glossaries, summaries and revision aids  
- alternative representations of existing material  
- accessibility-focused adaptations  

It can also support research communication, coding scaffolds and structured planning, provided the same principles of source control, verification and accountability are applied.

## Low-risk and higher-risk uses

| Lower-risk drafting support | Higher-risk use requiring greater control |
|---|---|
| reformatting lecturer-authored notes | generating content outside the lecturer's expertise |
| producing alternative examples for review | creating factual material without a source boundary |
| drafting formative discussion questions | generating live summative assessment questions or answers |
| simplifying an explanation for review | processing identifiable student work or feedback |
| creating a checklist from approved guidance | making decisions about marks, progression or misconduct |

> ⚖️ The issue is not whether AI was used, but what judgement was delegated, what information was shared and how the output was checked.

---

::: callout-task

#### Task 2: Generate a teaching resource

::: panel-tabset

##### Exercise (10 min)

Choose a topic that you teach and define:

1. one learning outcome  
2. the learner level and expected prior knowledge  
3. the teaching context and available time  
4. one approved source or set of notes  
5. the resource you want Copilot to draft  

Ask Copilot to generate one of the following:

- a short explanation with a worked example  
- a seminar or workshop activity  
- a case study with discussion questions  
- three formative questions with model reasoning  
- an accessible alternative version of an existing resource  

Save your prompt and output. Do not use personal student data, live student submissions or confidential material.

##### Plenary (5 min)

Be ready to explain:

- how your prompt represented the learning outcome and audience  
- what Copilot produced well  
- what was generic, inaccurate or pedagogically weak  
- what you would need to change before using the material  
...
#### Task 3: Critique the generated resource

::: panel-tabset

##### Exercise (10 min)

Evaluate the resource produced in Task 2.
...
#### Task 5: Build an agent for teaching-resource development
...
- **Local policy and support:** consult current institutional guidance before using AI with student information, assessment materials or restricted content.  
:::
