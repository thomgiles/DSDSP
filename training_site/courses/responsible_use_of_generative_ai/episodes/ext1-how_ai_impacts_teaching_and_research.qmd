...
Academics can use generative AI in several practical ways:
...
> ✍️ The key change is not simply faster content production. In the future, it is likley that staff will need to act as critical editors of AI-assisted materials, decisions and reasoning.

## AI led discovery

AI can increase the *breadth* of exploration by lowering the cost of asking “what if?” questions.
...
> ✅ This can improve teaching and research practice, but only *if* exploration is paired with clear aims and human validation.
...
> 📢 Staff are also responsible for setting clear expectations for students and for being transparent where AI materially shapes teaching or research outputs.  

## Contextual Permissions

Context Matters, Lots of factors can affect AI acceptability:
...
- AI can support teaching and research planning, explanation, accessibility, formative activity design, analysis and translation.
- Key opportunities include efficiency, broader exploration, clearer communication and reduced repetitive workload.
- Main risks include factual errors, bias, academic integrity concerns, copyright or IP issues, data breaches and loss of critical skills.
- Ethical use requires transparency, accountability, fairness, privacy and meaningful human oversight.
- Use secure, approved tools; do not upload sensitive material without authorisation; follow institutional and disciplinary policies.
:::
