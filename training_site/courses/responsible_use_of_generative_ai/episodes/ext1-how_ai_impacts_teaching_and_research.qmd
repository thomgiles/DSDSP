...
- Artificial Intelligence (AI) emerged as a concept in the early 1950s 
...
## Expansion of Rule-Based AI (1960s)
...
## Why Rule-Based AI Struggled (1980s)

Expert systems struggled because human expertise had to be encoded manually, often as **thousands of explicit rules** for diagnosis, recommendation, or classification.
...
In the late 1980s, machine learning emerged as researchers realised that instead of telling computers *how* to solve problems, they could let them *learn* from examples. 
...
## Data-Driven AI Becomes Practical (1990s–2000s)

- In the 1990s and 2000s, research shifted toward data-driven methods, with statistical models and support vector machines (SVMs) becoming standard in scientific and industrial settings.  
...
> 🧠 The important shift was that systems increasingly learned useful patterns from data rather than relying only on hand-written rules.
...
## Why Language Models Needed a New Approach (2014-2016)
...
Training transformer models on very large collections of text led to general-purpose foundation models. These models could be adapted to many different tasks rather than being built for only one narrow purpose.
...
> 🧠 Many current AI tools are built around very large transformer-based models.
...
## AI Changes Academic Workflows

Generative AI can reduce the time needed to draft, summarise, reformat and prepare academic materials. This affects curriculum planning, learning materials, synthesis, translation, feedback scaffolds and technical preparation.  
...
![AI can shorten drafting and synthesis paths in both teaching and research, so deliberate review points become more important.](fig/rai-research-lifecycle-compression.svg){fig-align="center" width="78%"}
...
AI is most useful when it helps staff do more preparation, comparison, checking or adaptation in the time available.
...
## AI Can Help You Explore More Options
...
Before using an AI tool with teaching or research material, unresolved questions include:
