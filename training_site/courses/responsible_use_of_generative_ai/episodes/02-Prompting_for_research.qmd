---
title: Developing Prompting for Research
metadata:
  teaching: 20
  exercises: 40
---
...
- [Springer Nature Editorial Policies – Artificial Intelligence](https://www.nature.com/nature-portfolio/editorial-policies/ai)  
- [SAGE AI Policy: Ethical Use of Generative AI in Research and Scholarly Publishing](https://psr.brunel.ac.uk/2024/5/04/the-ethical-use-of-generative-ai-in-publishing-and-research/) 
- [Joint Approach to Generative AI in Funding Applications (Cancer Research UK)](https://news.cancerresearchuk.org/2023/09/19/joint-approach-to-generative-ai-in-funding-applications/) 
- UKRI Generative AI in Application and Assessment Policy (Sept 2024; updated Dec 2024)](https://www.ukri.org/publications/generative-artificial-intelligence-in-application-and-assessment-policy/)
- [COPE Authorship and AI tools policy](https://publicationethics.org/guidance/cope-position/authorship-and-ai-tools)
...
> 🧭 The chain is useful because it separates generation, critique, and verification into visible steps.

> 🧭 A staged prompt chain is less about cleverness than control: it helps separate drafting, critique, refinement, and verification so the final output is more reliable and easier to defend.
...
> ✅  Once this workflow is defined, you only need to provide the *topic* or organisation and the agent should cary out the process consistently each time.
