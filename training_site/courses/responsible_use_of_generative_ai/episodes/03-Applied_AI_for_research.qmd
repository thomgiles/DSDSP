...
1. What could we be asking AI to do, and what evidence can it actually see?
2. How do we check the answer and show how it was produced?
...
>Dont pick tools just because they sound cool!
...
|---|---|
| **Capability** | Is the tool good at the task: reasoning, coding, images or long documents? |
| **Functionality** | Can it actually perform the task you need? |
| **Output** | Does the result match the source, data or calculation? |
| **Data handling** | Where is data processed, stored or logged? |
| **Use conditions** | Are the licence and external connections appropriate? |
...
## Task 1: Choose an Approach {background-color="#2b2b2b"}
...
Before using AI, be clear about **what you are trying to do**.

- **Why?** Prepare for a supervision meeting.
- **What?** Explore whether peer writing groups help researchers write regularly.
- **Focus on?** Writing time, confidence and completed work.

> A clear starting point helps AI stay focused on the question you actually want to answer.
...
1. Check it has permission to use each document in the selected service.
...
> Dont assume an AI tool can interpet every bit of information you give it! 

## Understand How Documents Reach the Model

Many document tools first search the uploaded material for relevant passages and then give those to the model. 

This is often called **retrieval-augmented generation (RAG)**. 

It can make answers easier to trace, but the search step can miss important evidence.

> 📄 
Ask for section headings, printed page numbers or passage locations. Mark the location as unavailable when the tool cannot provide it reliably. Being able to accept a long document does not mean the tool gives equal attention to every page.
...
You can ask an AI assistant to:
 ...
 - Identify other possible interpretations. 
 
 But you need to check these points yourself against the sources and method.

> Asking a real life research assistant to approve their own answer is not independent verification. The same goes for AI. 
...
## Task 2: From Request to Workflow {background-color="#2b2b2b"}
...
Lets start with a theoretical project that is studying the affects of study groups on writing time. 

They observe that after a 6 week period of study group meetings, people tended to write more. 
...
eadlines, supervision, motivation or workload.

> The same observation can often be explained in several different ways.

## Build a Theoretical Explanation

Normally a resescher would build a theory to test **how or why different concepts might be related**.
...
> Other factors may influence that relationship, such as **motivation, workload or caring responsibilities**: A plausible explanation is still something to test.
...
| Accountability matters | Peer contact influences drive to write |

> Explanation should only be made into prediction based on evidence
...
> 📝 You can actually ask AI to challenge the idea, not just support it.

## Compare Ideas with Evidence

Once you have possible explanations, the normal approach is to compare them against the evidence.

**Does the evidence support one or more of our explanations?**  

**Does anything contradict some of them?**  

**What evidence is still missing?**

> Keep **evidence**, **researcher interpretation** and **AI suggestions** as separate components in you work.
...
## Task 3: Match the Claim to the Evidence {background-color="#2b2b2b"}
...
> Resources like [PRISMA 2020](https://www.prisma-statement.org/prisma-2020) help teams plan out how they report this work transparently.
...
AI can help build a search, but you still need a clear method and a record of what you did.

1. Break the question into its main ideas.
2. List synonyms and database subject headings.
3. Search suitable databases such as PubMed, Scopus or Web of Science.

> 🧭 Keep the exact search terms, database, date and filters used.

## Extend and Record the Search

Use other routes to find papers that your first search may have missed.

| Route | What to do |
|---|---|
| AI-assisted discovery | Explore extra terms and candidate papers |
| Citation searching | Follow references backwards and citations forwards |
| Reference management | Export records and check for duplicates |

> [ResearchRabbit](https://www.researchrabbit.ai/) and [Litmaps](https://www.litmaps.com/) can help explore connections between papers.
...
## Task 4: Challenge the Synthesis {background-color="#2b2b2b"}
...
## Task 5: Find the Hidden Error {background-color="#2b2b2b"}
...
## Task 6: Bound the Automation {background-color="#2b2b2b"}
...
> Take note; AI use during application interviews is prohibited.
...
## Task 7: Does the Idea Fit the Call? {background-color="#2b2b2b"}
...
Ways around this problem incldude using: 

**fake data · example texts · Blank templates · Data structures**
...
## Task 8: Can You Use This Data? {background-color="#2b2b2b"}
