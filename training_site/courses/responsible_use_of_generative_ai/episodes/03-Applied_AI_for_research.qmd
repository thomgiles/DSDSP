...
These are starting points, not performance rankings. 

N.b. Features, names, subscriptions and institutional access can and will change over time!

## Match the Tool to the Task: Discovery and Search
...
What do you think is the **single most important change** that would make this request inspectable?
...
**Writing group → protected time → more regular writing**
...
Validation comes from appropriate **literature, data, analysis, experiments and disciplinary expertise**.
...
![](fig/rai-ideas-to-research-flow.svg){fig-alt="A six-stage reasoning flow from an observation through explanation, alternatives, prediction and evidence to a research design." fig-align="center" width="92%"}
...
An early exploration, a narrative review and a systematic review are different kinds of work. Decide the purpose, question and method before choosing a tool.

For a systematic or scoping review, work with an information specialist where possible. Set the rules for which studies count, where you will search, how records will be selected and what information will be extracted. 

[PRISMA 2020](https://www.prisma-statement.org/prisma-2020) and its extensions help teams report this work transparently; following a checklist does not by itself make the review sound.

## “Deep Research” Is Not a Review Method

An automatically generated “deep research” report can help you get oriented. The label does not mean that the search can be repeated, that the coverage is complete or that the result is a systematic review.

Ask: 

**Could another researcher understand what was searched, selected, extracted and checked?**
...
AI may support individual stages. It does not replace the review method or the record of decisions.
...
## Two Routes, the Same Need for Checks

![](fig/rai-analysis-checkpoints.svg){fig-alt="Human checkpoints in qualitative and quantitative analysis: source text remains connected to interpretation, while raw data remains connected to executed code and checked results." fig-align="center" width="89%"}
...
## Qualitative Analysis: Preparing the Data

AI can help with some of the **early, repetitive work**.
...
> 🧭 AI can support the process, but it should not replace close reading.

## Qualitative Analysis: Making Sense of the Data

AI can help organise patterns and compare different parts of the dataset.
...
## If You Use a Codebook, Define the Rules

A **codebook** is a list of labels used to classify parts of the data.

For each code, define **what it means, when to use it and when not to**.

Test AI suggestions on a small sample before using them more widely.

> 🧭 Keep disagreements and record any changes to the codebook.


## Qualitative Analysis Is Often Interpretative

In [thematic analysis](https://www.thematicanalysis.net/doing-reflexive-ta/), themes are developed through reading and interpretation.

The researcher's perspective is part of that process.

AI can suggest patterns or alternative readings, but these are **ideas to consider**.

> 🔎 Something is not necessarly important simply because AI finds it frequently.


## For Qualitative Research, Give AI Clear Instructions

You will generally get better responses if you AI to:

- use only the supplied extracts
- suggest possible descriptive codes
- show the quotation supporting each suggestion
- include alternative interpretations and uncertainty
- avoid inventing experiences, motives or quotations

> Treat the output as suggestions for human review.


## Quantitative Analysis

Before asking AI to analyse data, explain **what each variable means** and what you want to test.

Check:

1. Names, data types, IDs and units.
2. Missing values, duplicates and obvious problems.
3. The proposed analysis and its assumptions.

> 🧭 Check the data before transforming or analysing it.

## Make It Reproducible

Ask AI to produce code that **keeps the original data unchanged**.

Then:

1. Run the code and inspect the output.
2. Record exclusions and newly calculated variables.
3. Check a small calculation independently.
...
Writing time per week at 0 and 6 weeks, `NA` means **missing**, not zero.
...
## Make sure AI based drafting is constrained by the evidence
...
## AI Reviewer Scores Are Not Predictions
...
- Run a flexible peer writing group.
...
AI cannot take responsibility for research.

Researchers remain responsible for:

**evidence · methods · interpretation · writing · conclusions**

Make sure you stay upto date with the rules set by the **institution, funders and publishers you work with**.
