...
The introductory lessons can run as one 2-hour workshop or two linked one-hour sessions. The applied lesson adds three hours of learning time, plus breaks, and can be split into shorter sessions.
...
Use [Applied AI for Research](../episodes/03-Applied_AI_for_research.qmd) to connect tool selection and prompting to the research lifecycle. Follow the short teaching sections with evidence checking, design decisions and workflow practice. The eight activities total 90 minutes alongside 90 minutes of teaching.
...
- Split groups between the qualitative and quantitative analysis routes, or select the route that best fits the audience. Both routes are available for further practice.
- Check the numerical exercise against five complete pairs and a mean change of 0.4 hours/week. In qualitative work, expect justified differences in interpretation rather than one correct set of themes.
...
- Assess the final AI use note for specific checks and decisions, not the fluency of the generated output.
