...
2. Triggers and flow start points (~10+10 min)
3. Connectors and data movement (~10+10 min)
4. Expressions, functions, and routing (~10+10 min)
5. Approvals, Excel tables, and template emails (~10+10 min)
...
![The workshop flow starts with a manual request, adds notification, expressions, approval, Excel rows, test emails, and run history checks.](fig/workshop-build.svg){fig-align="center" width="88%"}
