...
```{mermaid}
flowchart LR
    A[Define Research Question] --> B[Collect Data]
    B --> C[Analyse Results]
...
#### Task 1: Discover — Why Work Iteratively?
...
```{mermaid}
graph TD
    PI["<b>Principal Investigator (PI)</b><br>Leads the research project"]:::lead
    PR["<b>Postdoctoral Researchers</b><br>Conduct analyses"]:::exec
    AN["<b>Analysts</b><br>Develop methods"]:::exec
    PM["<b>Project Managers</b><br>Coordinate timelines and deliverables"]:::coord
    SE["<b>Subject Experts</b><br>Provide domain knowledge and advice"]:::advice
    ...
    classDef lead fill:#E8F5E9,stroke:#2E7D32,stroke-width:2px;
    classDef exec fill:#E3F2FD,stroke:#1565C0,stroke-width:1px;
    classDef coord fill:#FFF3E0,stroke:#EF6C00,stroke-width:1px;
    classDef advice fill:#F3E5F5,stroke:#6A1B9A,stroke-width:1px;
```
...
```{mermaid}
flowchart LR
    PO["<b>Product Owner</b><br>Sets research vision and priorities"]:::lead
    SM["<b>Scrum Master</b><br>Facilitates process <br> and removes blockers"]:::coord
    DEV["<b>Development Team</b><br>Executes analyses <br> and refines outputs"]:::exec

    PO --> SM
    SM --> DEV
    DEV --> PO

    style PO fill:#E8F5E9,stroke:#2E7D32,stroke-width:1px
    style SM fill:#FFF3E0,stroke:#EF6C00,stroke-width:1px
...
#### Task 2: Map — Roles in Agile Research Teams
...
#### Task 3: Apply — Design a Two-Week Research Sprint
...
- Treat feedback as dialogue — not evaluation  
...
#### Task 4: Integrate — Sprint Simulation and Reflection
...
![](fig/feedback.png){fig-align="center" width=400px}
