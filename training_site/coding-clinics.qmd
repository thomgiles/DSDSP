...
The aim is not simply to fix the immediate issue. A good clinic helps the learner understand what happened, how to diagnose similar problems, and what to practise next.
:::
...
::: {.landing-section .coding-clinic-cta}
::: {.landing-section-heading}
## How Clinics Connect To The Programme

Clinics complement the taught modules. Workshops introduce shared concepts and methods; clinics help learners apply those ideas to messy real projects.
:::
