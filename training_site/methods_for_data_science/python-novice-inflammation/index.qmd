---
title: "Python Novice Inflamaition"
subtitle: "Adapted from the software carpentry course"
format:
  html:
    toc: true
...
The data sets are stored in [comma-separated values](learners/reference.md#comma-separated-values) (CSV) format:
...
You need to understand the concepts of **files** and **directories** and how to start a Python interpreter before tackling this lesson. This lesson sometimes references Jupyter Notebook although you can use any Python interpreter mentioned in the [Setup](learners/setup.md).
...
To get started, follow the directions on the [Setup](learners/setup.md) page to download data and install a Python interpreter.