...
Or alternatively another common way of sub-setting is by using a logical vector. TRUE will select the element with the same index, while FALSE will not
...
#### Matrix
 ...
 Matrices are two-dimensional, homogeneous data structures (i.e. they are tables of data of the same type most frequently numeric. 
